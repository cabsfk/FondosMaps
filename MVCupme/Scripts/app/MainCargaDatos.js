...
function getParametros() {
    ...
    $('#labelfechafin').empty().append($('#date_fin').data("DateTimePicker").date().format('DD/MM/YYYY'));
...
function CuentaTbs(featureCollection) {
    ...
    $("#ValorConTotal").empty().append(numeral(ValorTotal / 1000000).format('$0,0') + config.mill);
    ValorTotal = sumCampo(featureCollection, 'VPUA');
    $("#ValorConTotalCons").empty().append(numeral(ValorTotal / 1000000).format('$0,0') + config.mill);
    ...
    $('#lbValorFav').empty().append(numeral(TotalFavorable / 1000000).format('$0,0') + config.mill);
    TotalFavorable = sumCampo(fcFavorable, 'VSUA');
    $('#lbValorFavCons').empty().append(numeral(TotalFavorable / 1000000).format('$0,0') + config.mill);
    ...
    $('#lbValorAsig').empty().append(numeral(TotalAsig / 1000000).format('$0,0') + config.mill);
    TotalAsig = sumCampo(fcAsig, 'VASUA');
    $('#lbValorAsigCons').empty().append(numeral(TotalAsig / 1000000).format('$0,0') + config.mill);
